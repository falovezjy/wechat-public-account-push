export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe0afaa3056f31630",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c8b4c1f1c6382ddbfd2dfb3843accf02",
   ...
   */
  USERS: [omlYI6OxMT9K2cUdnCcxVYsMnJ_8]
    {
      // 想要发送的人的名字
      name: "张嘉怡",
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "_Mj9EENpk6UrYLTDVFuXO727QfU2m3HFujdi1tz7ByU",
      // 所在省份
      province: "哈尔滨",
      // 所在城市
      city: "呼兰区",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2003", "date": "02-06"},
        {"type": "节日", "name": "恋爱纪念日", "year": "2022", "date": "09-12"},
